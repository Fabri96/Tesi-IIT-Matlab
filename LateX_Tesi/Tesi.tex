...
% -> title of your work
\renewcommand{\title}{Data analysis and differential modeling of the neural activity in SOM+ interneurons of the mPFC in mice}
...
\newcommand{\firstcoadvisor}{Dott. FRANCESCO PAPALEO} % insert if any otherwise comment
