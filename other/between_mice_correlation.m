...
c_matrix_stress = corr_matrix_between_mice(m_detector_obs,m_detector_stress,dt);

c_matrix_neutral= corr_matrix_between_mice(m_detector_obs,m_detector_neutral,dt);


c_matrix_stress_cage = corr_matrix_between_mice(m_detector_obs_cage,m_detector_stress_cage,dt);

c_matrix_neutral_cage= corr_matrix_between_mice(m_detector_obs_cage,m_detector_neutral_cage,dt);


c_matrix_stress_hab = corr_matrix_between_mice(m_detector_obs_hab,m_detector_stress_hab,dt);

c_matrix_neutral_hab= corr_matrix_between_mice(m_detector_obs_hab,m_detector_neutral_hab,dt);
...
title('Average interneuronal correlation between observer and stressed')
set(gca,'FontSize',20)


figure
plot(aa, [mean(c_matrix_neutral_cage(:)) mean(c_matrix_neutral_hab(:)) mean(c_matrix_neutral(:))],'b-o','LineWidth',3)
title('Average interneuronal correlation between observer and neutral')
set(gca,'FontSize',20)
