...
load("oasis_mouse_317.mat")
load ("oasis_mouse_318.mat")
load("oasis_peaks_317.mat")
load("oasis_peaks_318.mat")
...
%% SPLIT DATA
zone318_post=zone_318_post ;
[m1_pre, m1_test, m1_post,m2_pre,m2_test,m2_post] = one_one_accept_split(oasis_mouse_317, oasis_mouse_318,dataset);
...
[m2_post_near,m2_post_far,zone_post_m2] = one_one_zones(m2_activity_post,zone318_post);
