% ang_dist_test_stress= angular_distance(obs_activity_test_stress...
%     -mean(obs_activity_test_stress),stress_activity_test2 ...
%     -mean(stress_activity_test2));
% 
% ang_dist_test_neut= angular_distance(obs_activity_test_neutral...
%     -mean(obs_activity_test_neutral),neutral_activity_test2...
%     -mean(neutral_activity_test2));
% 
% ang_dist_hab_stress= angular_distance(obs_activity_hab_stress...
%     -mean(obs_activity_hab_stress), stress_activity_hab2...
%     -mean(stress_activity_hab2));
% 
% ang_dist_hab_neut= angular_distance(obs_activity_hab_neutral...
%    - mean(obs_activity_hab_neutral),neutral_activity_hab2...
%    - mean(neutral_activity_hab2));
